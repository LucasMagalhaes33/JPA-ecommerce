...
insert into pedido (id, cliente_id, data_criacao, total, status) values (5, 1, sysdate(), 998.0, 'AGUARDANDO');
insert into pedido (id, cliente_id, data_criacao, total, status) values (6, 1, sysdate(), 499.0, 'AGUARDANDO');
